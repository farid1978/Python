----- [01_11_usercell_other.sql]
----- [2/3/4/5G]

insert into table sdr_ps.TBL_PREFIX_cee_user_cell_other_tbl
select 
  ...
  , case when (b.protocol <> '' or b.protocol is not null) then b.protocol else 'Other' end as srv
...
from ps.detail_ufdr_other_XDR_suffix a 
left join nethouse.dim_protocol b on b.protocol_id = a.prot_category
where 
